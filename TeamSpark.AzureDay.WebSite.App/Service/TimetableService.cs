...
namespace TeamSpark.AzureDay.WebSite.App.Service
{
	public sealed class TimetableService
	{
		...
		public TimetableService()
		{
			...
			{
				new Timetable { TimeStart = "9:00", TimeEnd = "10:15", Room = _roomService.Room1 },
			...
			{
				new Timetable { TimeStart = "10:30", TimeEnd = "11:30", Room = _roomService.Room2, Topic = _topicService.ASurkov_01 },
				new Timetable { TimeStart = "12:00", TimeEnd = "13:00", Room = _roomService.Room2, Topic = _topicService.VThavonekham_01 },
				new Timetable { TimeStart = "13:15", TimeEnd = "14:15", Room = _roomService.Room2 },
			...
			{
				new Timetable { TimeStart = "10:30", TimeEnd = "11:30", Room = _roomService.Room5 },
