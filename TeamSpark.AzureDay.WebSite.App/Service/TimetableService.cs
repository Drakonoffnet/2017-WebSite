	...
	public sealed class TimetableService
	{
		...
		public TimetableService()
		{
			...
			_timetables.AddRange(new List<Timetable> // it-pro
			{
				...
				new Timetable { TimeStart = "12:00", TimeEnd = "13:00", Room = _roomService.Room5, Topic = _topicService.MSmereczynski_01 },
				new Timetable { TimeStart = "13:15", TimeEnd = "14:15", Room = _roomService.Room5, Topic = _topicService.ATkachenko_02 },
